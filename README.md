...
**RNF** => Requisitos não funcionais: requisitos que não estão diretamente ligados
com a aplicação. Ex: qual blibliotecas utilizar.

**RN** => Regra de negócio. Regras por trás dos requisitos funcionais.
